                        ...
                        <div class="notes">
                            ...
                            <div class="dialog">
                                <div onclick="pinNote(${i})"><img
                                        src="/fotoapp/img/bookmark-regular-not-active.svg" title="Pin Note" alt="Pin Note">
                                </div>
                                <div><img src="/fotoapp/img/pen-to-square-solid.svg" title="Edit Note" alt="Edit Note">
                                </div>
                                <div onclick="archiveNote(${i})"><img src="/fotoapp/img/circle-down-regular.svg" title="Archive Note" alt="Archive Note">
                                </div>
                                <div onclick="moveToTrashOpen(${i})"><img
                                        src="/fotoapp/img/trash-can-regular.svg" title="Move to Trash" alt="Trash Note">
                                </div>
                        ...
                        ${pinnedNote[i]}
                         ...
                         <div class="dialog">
                                <div onclick="unPinNote(${i})"><img
                                        src="/fotoapp/img/bookmark-solid.svg" title="Pin Note" alt="Pin Note">
                                </div>
                                <div><img src="/fotoapp/img/pen-to-square-solid.svg" title="Edit Note" alt="Edit Note">
                                </div>
                        ...
                        ${archive[i]}
                         ...
                         <div class="dialog">
                                ...
                                <div onclick="unSetArchiveNote(${i})"><img
                                        src="/fotoapp/img/lightbulb-regular.svg" title="Restore Note" alt="Restore Note">
                                </div>
                        ...
                        ${trash[i]}
                         ...
                         <div class="dialog">
                                ...
                                <div onclick="togglePopup(${i})"><img
                                        src="/fotoapp/img/trash-can-regular.svg" alt="Trash Note">
                                </div>
